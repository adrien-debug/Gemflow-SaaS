...
const useAddOtherMaterialBatch = () => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: (dto: CreateOtherMaterialTransactionDto) => OtherMaterialTransactionsApi.add(dto),
...
export default useAddOtherMaterialBatch;
