...
const StockAvailableStatistic: FC<Props> = ({ searchInput, stockStatuses }) => {
  ...
  return (
    <Flex gap={8}>
      <LabelValueCard label="Available items" loading={isFetching}>
        {data?.totalCount}
      </LabelValueCard>
...
export default StockAvailableStatistic;
